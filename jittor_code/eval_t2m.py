...
print(f"Transformer load missing_keys={len(missing_keys)}, unexpected_keys={len(unexpected_keys)}")
if missing_keys:
    print("Missing key sample:", missing_keys[:8])
if unexpected_keys:
    print("Unexpected key sample:", unexpected_keys[:8])
assert len(unexpected_keys) == 0
assert all([k.startswith('clip_model.') for k in missing_keys])
if missing_keys:
    print("WARNING: transformer checkpoint does not contain clip_model.*; current CLIP module controls text conditioning.")
