...
def get_args_parser(is_train=False):
    ...
    parser.add_argument('--data-root', type=str, default=None, help='override dataset root for evaluation/smoke runs')
    parser.add_argument('--eval-model-pth', type=str, default=None, help='override evaluator checkpoint path; for InterX this may also be the text2motion checkpoints dir')
    parser.add_argument('--eval-batch-size', type=int, default=None, help='override evaluator batch size')
    parser.add_argument('--replication-times', type=int, default=20, help='number of evaluation replications')
    parser.add_argument('--max-eval-batches', type=int, default=None, help='limit evaluation batches for smoke tests')
    parser.add_argument('--no-mm', action='store_true', help='disable multimodality evaluation for smoke tests')
    parser.add_argument('--mm-num-repeats', type=int, default=30, help='multimodality repeats per batch')
    parser.add_argument('--mm-num-times', type=int, default=10, help='multimodality sample pairs')
