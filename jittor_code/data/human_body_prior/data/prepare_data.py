...
import shutil, sys
from utils.jittor_data import Dataset
import glob
...
def prepare_vposer_datasets(vposer_dataset_dir, amass_splits, amass_dir, logger=None):
    ...
    logger('Creating Jittor-compatible dataset at %s' % vposer_dataset_dir)
    ...
    logger('Dumped final Jittor-compatible dataset at %s' % vposer_dataset_dir)